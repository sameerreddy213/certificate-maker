...
const CertificateTemplateSchema = new mongoose_1.Schema({
    ...
    owner: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true }, // Assumes a User model exists
}, { timestamps: true });
exports.default = mongoose_1.default.model('CertificateTemplate', CertificateTemplateSchema);
